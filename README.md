...
- [**Auditoría Consolidada de Marketing 360°**](consolidado/auditoria-consolidada-marketing-360.md) — 19-ago-2026. Contrasta las 9 auditorías Claude Code de arriba contra el Diagnóstico Estratégico 360° de la agencia (Constanza Zárate, ago-2026): coincidencias, omisiones de cada lado, verificación de cifras y jerarquización consolidada. Generada con la skill `auditoria-consolidada-marketing-360`. Backlog consolidado (32 tareas, sin duplicados con los backlogs de arriba) en [`consolidado/backlog-consolidado-clickup.csv`](consolidado/backlog-consolidado-clickup.csv).

Versiones editables en Word: carpeta [`/descargables`](descargables/). El desglose ClickUp también incluye un CSV plano en [`/descargables/Tareas-ClickUp-Import.csv`](descargables/Tareas-ClickUp-Import.csv) para adaptar al importador de ClickUp; el backlog consolidado tiene su propio CSV en [`/descargables/Backlog-Consolidado-ClickUp-Import.csv`](descargables/Backlog-Consolidado-ClickUp-Import.csv).
...
8. *(Ajuste 19-08-2026, tras contrastar con el Diagnóstico Estratégico 360° de la agencia — ver [auditoría consolidada](consolidado/auditoria-consolidada-marketing-360.md)):* resolver el acceso bloqueado a Google Ads (developer token, marcado P0 en el "Complemento Google Ads/Gobernanza ClickUp", aún no versionado en este repo — ver DOC-12 en el inventario de la auditoría consolidada) y ordenar Pipedrive hacia adelante para medir tasa de cierre real — sin esto, arreglar tracking y campañas (puntos 1-2) deja sin resolver la mayor parte del problema real de crecimiento del negocio.
