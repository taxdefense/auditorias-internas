...
- [**Auditoría Consolidada de Marketing 360°**](consolidado/auditoria-consolidada-marketing-360.md) — 19-ago-2026. Contrasta las auditorías Claude Code de arriba contra el Diagnóstico Estratégico 360° de la agencia (Constanza Zárate, ago-2026): coincidencias, omisiones de cada lado, verificación de cifras y jerarquización consolidada. Generada con la skill `auditoria-consolidada-marketing-360`. Backlog consolidado (32 tareas, sin duplicados con los backlogs de arriba) en [`consolidado/backlog-consolidado-clickup.csv`](consolidado/backlog-consolidado-clickup.csv).

Versiones editables en Word: carpeta [`/descargables`](descargables/). El desglose ClickUp del contrato incluye un CSV plano en [`/descargables/Tareas-ClickUp-Import.csv`](descargables/Tareas-ClickUp-Import.csv), el backlog de intervenciones SEO/Landing en [`/descargables/Backlog-ClickUp-SEO-Landing-Import.csv`](descargables/Backlog-ClickUp-SEO-Landing-Import.csv), y el backlog consolidado en [`/descargables/Backlog-Consolidado-ClickUp-Import.csv`](descargables/Backlog-Consolidado-ClickUp-Import.csv) — los tres listos para el importador de ClickUp.
