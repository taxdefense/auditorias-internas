...
| DOC-12 | Complemento Google Ads — Gobernanza ClickUp | PDF (`Downloads/.../1. Complemento-Google-Ads-Gobernanza-ClickUp.pdf`) | Claude Code | Gobernanza / Google Ads | 18-08-2026 | — | Backlog (3 tareas) | Vigente, **no está en el repo Markdown** | Confirma que el acceso a Google Ads (developer token) estaba bloqueado — explica por qué no hay auditoría Claude Code de campañas Google Ads |
| DOC-13 | Backlog ClickUp — SEO y Landing Page | PDF (`Downloads/.../2.1. Backlog-ClickUp-SEO-Landing.pdf`) | Claude Code | SEO / Landing | 19-08-2026 | — | Backlog (24 tareas, SL1-SL24) | Vigente, **no está en el repo Markdown** | Consolida DOC-01 + DOC-02 en tareas priorizadas por impacto×esfuerzo; señala explícitamente que SL1 y SL6 ya existen en DOC-05 (evita duplicado) |
